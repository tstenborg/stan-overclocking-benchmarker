...
[![super-linter](../../actions/workflows/super-linter.yml/badge.svg)](../../actions/workflows/super-linter.yml)
...
"Benchmarking Stan under Dynamic Overclocking with ThrottleStop"
[[1](#references)]. That article discusses the impact of dynamic overclocking
on benchmarking the Stan probabilistic programming language. The ThrottleStop
CPU throttling utility was used to moderate overclocking for an example
Bayesian inference task in astronomy.

---

<figure>
  <img src="assets/runtime-vs-iteration-under-overclocking.png" alt="Example runtimes for Stan's Bayesian inference with and without system overclocking." width="1272">
...
&nbsp;&nbsp; Bottom (left) overclocking, logical cores, (right) no overclocking, logical cores.<br /><br />
...
| PowerShell             | Free. Included in Windows 11.                                                                                                                                                                       |
...
1. T. N. Stenborg, "Benchmarking Stan under Dynamic Overclocking with
   ThrottleStop", in _Astron. Data Anal. Softw. Syst. XXXII_, in Astronomical
   Society of the Pacific Conference Series, vol. 538, S. Gaudet, D. Bohlender,
   S. Gwyn, A. Hincks and P. Teuben, Eds., 2025, pp. 265&ndash;268, doi:
   10.26624/GAQB5323.\
